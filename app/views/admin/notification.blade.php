...
@section('content-admin')
    ...
    <script type="text/javascript">
        ...
        @foreach ($increase_limits as $increase_limit)
            ...
            increase_limit_address[{{{$increase_limit->id}}}] = '{{{$increase_limit->address}}}';
            increase_limit_current_address[{{{$increase_limit->id}}}] = '{{{$increase_limit->current_address}}}';
            increase_limit_place_birth[{{{$increase_limit->id}}}] = '{{{$increase_limit->place_birth}}}';
            increase_limit_date_birth[{{{$increase_limit->id}}}] = '{{{$increase_limit->date_birth}}}';
