...
(function ($) {
    ...
    $.fn.strength.defaults = {
        ...
        mainTemplate: '<div class="kv-input">{input}</div><div class="kv-meter">{meter}</div>',
        meterClass: 'kv-meter',
        ...
        verdictClasses: {
            0: 'label-password label-default',
            1: 'label-password label-danger',
            2: 'label-password label-warning',
            3: 'label-password label-info',
            4: 'label-password label-primary',
            5: 'label-password label-success',
        },
        rules: {
            midChar: 2,
            consecAlphaUC: 2,
